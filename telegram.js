(() => {
  ...
  function addInterfaceFixes(){
    ...
    style.textContent=`
      ...
      .precision-3-card::after{content:"5/5 LIVE";position:absolute;right:10px;bottom:9px;z-index:5;padding:4px 8px;border-radius:999px;background:rgba(16,185,129,.2);border:1px solid rgba(110,231,183,.55);color:#a7f3d0;font-size:10px;font-weight:900;letter-spacing:.1em}
  ...
  function addProCards(){
    ...
    makeCard({key:"luckyjet-precision-3",cls:"precision-3-card",badge:"PRECISION 3",name:"LUCKY JET 1.50X",studio:"ДО 3 РАУНДОВ • LIVE 5/5",file:"precision-3/",aria:"Открыть Lucky Jet PRECISION 3"});
